...
RDEPEND="media-libs/fontconfig
	...
	x11-libs/libSM
	x11-libs/libXi
	~x11-libs/qt-core-${PV}[debug=,glib=,qt3support=,kde-qt=]
	~x11-libs/qt-script-${PV}[debug=,kde-qt=]
	cups? ( net-print/cups )
	dbus? ( ~x11-libs/qt-dbus-${PV}[debug=,kde-qt=] )
	gtk? ( x11-libs/gtk+:2 )
...
PDEPEND="qt3support? ( ~x11-libs/qt-qt3support-${PV}[debug=,kde-qt=] )"
