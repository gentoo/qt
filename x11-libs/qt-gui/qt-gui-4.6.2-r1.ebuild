...
IUSE="+accessibility cups dbus +glib gtk hildon mng nas nis raster tiff qt3support xinerama"

MY_HILDON_P="${PN}-hildon-${PV}"

SRC_URI+=" hildon? ( http://dev.gentoo.org/~wired/distfiles/${MY_HILDON_P}.tar.bz2 ) "
